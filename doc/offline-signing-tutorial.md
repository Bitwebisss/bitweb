...
This workflow uses [Partially Signed Bitweb Transactions](https://github.com/Bitwebisss/bitweb/blob/master/doc/psbt.md) (PSBTs) to transfer the transaction to and from the offline wallet for signing using the private keys.
