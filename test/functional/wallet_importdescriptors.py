...
class ImportDescriptorsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=1) as thread:
            with self.nodes[0].assert_debug_log(expected_msgs=["Rescan started from block 3f94bbf69252f4fe9380403dba2e16b8d7f1bb9007c3ef20890bfac7ddeacc9c... (slow variant inspecting all blocks)"], timeout=10):
