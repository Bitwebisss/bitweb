...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/Bitwebisss/bitweb/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/Bitwebisss/bitweb/blob/master/doc/tracing.md#tracepoint-validationblock_connected
